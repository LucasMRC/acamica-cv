...
function CompetenciasController () {
	...
	this.obtenerOpciones = function (id){
		...
		// La siguiente línea de código ES UNA CHANCHADA. Es sólo a modo de mostrar el errorMsg en el FrontEnd.
		// Idealmente, buscaría la manera de implementar un async/await con ajax.
		setTimeout(() => (opciones.status === 404) && alert(opciones.responseJSON), 500);
	},
